...
3. **Plan before Act:** Always propose a plan and get user approval before implementing code or taking actions. See the "Plan before Act" rule in AGENTS.md.
4. **Project workflow** Follow the rules in AGENTS.md when you are working on a GitHub repository.
