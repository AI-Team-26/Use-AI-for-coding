...
~/.git-credentials is supposed to be set with the PAT of the agent account ({{GITHUB_AGENT_ACCOUNT}}), at least, and records with PAT for each repo not owned by the GitHub account.  
